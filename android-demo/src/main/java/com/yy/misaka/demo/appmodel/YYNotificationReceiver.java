...
public class YYNotificationReceiver extends NotificationReceiver {
    ...
    public void onNotificationClicked(Context context, PushedNotification notification) {
        Log.d("DemoLogger", "YYNotificationReceiver onNotificationClicked " + notification.id + " values " + notification.payload);
        Toast.makeText(context, "YYNotificationReceiver clicked payload: " + notification.payload, Toast.LENGTH_SHORT).show();
    ...
    public void onNotificationArrived(Context context, PushedNotification notification) {
        Log.d("DemoLogger", "YYNotificationReceiver onNotificationArrived " + notification.id + " values " + notification.payload);
    }
